...
public:
	...
	//C2947
	//template<class T>
	//static CTraceableParam<T*, typename CTraceableParamBase<T*>::default_formatter<T*>, typename CTraceableParamBase<T*>::default_display_value_provider> GetOut(const std::basic_string<TCHAR>& name, T* value) {
